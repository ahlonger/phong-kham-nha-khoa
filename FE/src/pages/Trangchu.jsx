...
import { FaCalendarAlt, FaUsers, FaBoxOpen, FaComments, FaPlus, FaCheck } from "react-icons/fa";
...
const TrangChu = () => {
  ...
  return (
    <div className="p-8">
      ...
      {/* Truy cập nhanh */}
      <h3 className="text-lg font-semibold mb-2 text-blue-700">Truy cập nhanh</h3>
      <div className="space-x-4 mb-8">
        <a href="#" className="text-blue-600 underline inline-flex items-center">
      ...
      {/* Hoạt động gần đây */}
      <h3 className="text-lg font-semibold mb-4 text-blue-700">Hoạt động gần đây</h3>
