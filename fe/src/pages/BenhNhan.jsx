...
const BenhNhan = () => {
  ...
  const [isLoggedIn] = useState(false); // Giả định trạng thái đăng nhập
  ...
  const handleSubmitReview = (e) => {
    ...
    if (rating > 0 && comment.trim()) {
      const newReview = {
        name: "Người dùng", // Giả định tên người dùng, có thể thay bằng tên thực từ trạng thái đăng nhập
        rating,
      ...
      <div className="pt-16">
        ...
        <section id="danh-sach-bac-si" className="w-[1200px] mx-auto p-10 rounded-xl text-center bg-gray-100">
          ...
          <div className="flex flex-wrap justify-between gap-6">
            {[
              { name: "BS. Nguyễn Văn A", spec: "Răng Hàm Mặt" },
          ...
          <div className="w-1/3 bg-white p-6 border-2 border-[#005b94] rounded-md shadow-md">
            ...
            <div className="space-y-4">
              <select className="w-full border p-2 rounded">
                <option>Vui lòng chọn phòng khám</option>
              </select>
              <select className="w-full border p-2 rounded">
                <option>Vui lòng chọn chuyên khoa</option>
              </select>
              <select className="w-full border p-2 rounded">
                <option>Vui lòng chọn bác sĩ</option>
              </select>
              ...
              <button className="w-full bg-[#2e7cc7] text-white py-2 rounded hover:bg-[#1b5fa7]">
                Tiếp theo
              </button>
            </div>
          </div>
